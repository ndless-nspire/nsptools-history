...
/**
 * Derived from http://www.devx.com/Java/Article/22018/1954
 * 	-> fixed a bug in recursive directory deletion
...
public class TempFileManager {
	...
	/**
	 * @param forceNew if true, a new directory is created even if another one is already in use.
	 */
	public static File getTempDir(boolean forceNew) throws IOException {
		// Check to see if you have already initialized a temp directory
		// for this class.
		if (forceNew || sTmpDir == null) {
	 ...
	 */
	private final static String TEMP_DIR_PREFIX = "ndless_install";
