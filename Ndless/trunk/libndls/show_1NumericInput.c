/*
  show_1NumericInput allows to invoke a 1 numeric input popup.

  show_1NumericInput compared to _show_1NumericInput avoid 
  ...
  How to use :
   ...
   int value = 7;
   int result = show_1NumericInput(title, subtitle, msg, &value, 1, 42);
   printf("%d(%s) : %d\n", result, (result == 5103)?"OK":"CANCELED", value); 
...
int show_1NumericInput(const char * title, const char * subtitle, const char * msg, int * value_ref, int min_value, int max_value) {
