...
// Basic syscalls table used by the loader
  ...
  .long OS_FUNC( power_off_ )         // Unused
	.long OS_FUNC( ascii2utf16_ )       // Unused
  .long OS_FUNC( show_dialog_box_ )   // Doesn't work because the heap is full
	.long OS_FUNC( show_dialog_box2_ )  // Doesn't work because the heap is full
	.long OS_FUNC( fopen_ )
	.long OS_FUNC( fclose_ )
	.long OS_FUNC( fread_ )
	.long OS_FUNC( memset_ )            // Unused
	.long OS_FUNC( memcpy_ )            // Unused
