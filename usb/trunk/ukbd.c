...
static unsigned short trtab_key[256] = {
	...
	0x1000|'\r', 0x7300|'1', 0x5300|'2', 0x3300|'3', 0x7200|'4', 0x5200|'5', 0x3200|'6', 0x700|'7', /* 58 - 5F */
	0x5100|'8', 0x3100|'9', 0x5000|'0', 0x0000    , 0x0000    , 0x0000    , 0x0000    , 0x0000    , /* 60 - 67 */
...
// Language support - sUSB usage ID to USB usage ID
